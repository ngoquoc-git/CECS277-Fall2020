public class Tabby extends Cat {
    ...
    /**
     * Create Tabby the cat
     * @param n name of Tabby
     */
    ...
    /**
     * Allow player to feed Tabby
     * @param p player's action
     * @return string display Tabby's status and action
     */
    public String feed(Player p) {
        String status;
        if (getHunger() > 0 && getHunger() < 6){ 
    ...
    /**
     * Allow player to play with Tabby
     * @param p player's action
     * @return string display Tabby's status and action
     */
    public String play(Player p) {
        ...
        else if (getHunger() > 2 && getHunger() < 7){
    ...
    /**
     * Allow player to pet with Tabby
     * @param p player's action
     * @return string display Tabby's status and action
     */
    public String pet(Player p) {
        ...
        else if (getHunger() > 6 && getHunger() < 10){
